<script>
	import { Reply, ThumbsUp } from 'lucide-svelte';
</script>

<section class="relative flex">
	<div class=" w-full">
		<!-- <div
			class="flex-col w-full py-4 bg-white border-b-2 border-r-2 border-gray-200 sm:px-4 sm:py-4 md:px-4 sm:rounded-lg sm:shadow-sm"
		>
		...
		<div class="flex-col w-full py-4 mx-auto mt-3 bg-neutral sm:px-4 sm:py-4 md:px-4 sm:shadow-sm">
			<div class="flex flex-row md-10">
				<img
					class="w-12 h-12 border-2 border-base-content/70 rounded-full"
				...
				<div class="flex-col mt-1">
					<div class="flex items-center flex-1 px-4 font-bold leading-tight">
						Anonymous
						<span class="ml-2 text-xs font-normal opacity-50">3 days ago</span>
					</div>
					<div class="flex-1 px-2 ml-2 text-sm font-medium leading-loose opacity-70">
						Very cool! I'll have to learn more about Tailwind.
					</div>
					<button class="inline-flex items-center opacity-50 hover:opacity-70 px-4 pt-2 ml-1 flex-column">
						<Reply size=16/>
					</button>
					<button class="inline-flex items-center opacity-50 hover:opacity-70 px-1 -ml-1 flex-column">
						<ThumbsUp size=16/>
					</button>
				</div>
			</div>
